                                ...
                                if exists("1556275994102-2.png"):
                                    ...
                                    if exists("1555945546079-3.png"):
                                        ...
                                        if exists("1556276030471-2.png"):
                                            ...
                                            if exists("1555945546079-3.png"):
                                                click("1555945546079-3.png")
                                                if exists("1556277934750.png"):
                                                    click("1556277934750.png")
            ...
            if exists("1555963836444-1.png", 0.5):
                ...
                if exists("1555956093762-1.png",0.5):
                    ...
                    while licenseNotes == False and cntr1 < 5:
                        cntr1 = cntr1 + 1
                        if exists ("1555946502227-1.png",0.5):
                            click("1555946502227-1.png");
                            type("a", KEY_ALT)
                    ...
                    if exists ("1555946399933-1.png",0.5):
                        ...
                        if exists ("1555946399933-1.png",0.5):
                            ...
                            if exists("1555958861159-2.png", 1):
                                ...
                                sleep(20)
                            if exists(Pattern("1555848367704-1.png").similar(0.80), 1):
                                click(Pattern("1555848391359-1.png").exact().targetOffset(25,-37))
                                sleep(10)
                            if exists("1555848885259-2.png", 1):
                                click("1555848885259-2.png")    
                                finalconfig = True